...
export default class App extends React.Component {
  constructor(props) {
    ...
    this.state = {
        ...
        [
          {
            ...
            link_name: 'AmzChart',
            link_descript: '可以根据评论数、价格、评分等，来筛选榜单数据。',
            link_category: 'videoDownLoad',
            link_category_name: '视频下载'
          },
          {
            img_name: 'icon2.png',
            link_url: 'http://www.baidu.com',
        ...
        [
          {
            ...
            link_name: '跨境头条',
            link_descript: '可以根据评论数、价格、评分等，来筛选榜单数据。',
            link_category: 'videoWebsite',
            link_category_name: '视频网站'
          },
          {
            img_name: 'icon3.png',
            link_url: 'http://www.baidu.com',
        ...
        [
          {
            ...
            link_name: '跨境头条',
            link_descript: '可以根据评论数、价格、评分等，来筛选榜单数据。',
            link_category: 'atlasWebsite',
            link_category_name: '图库网站'
          },
          {
            img_name: 'icon3.png',
            link_url: 'http://www.baidu.com',
      ...
      resourcesBuyData: [
        [
          { img_name: 'icon1.png', link_url: 'http://www.baidu.com', link_name: '跨境头条', link_descript: '最全跨境电商每日资讯', link_category: 'resourcesBuy', link_category_name: '资源购买' },
          { img_name: 'icon2.png', link_url: 'http://www.baidu.com', link_name: '跨境头条', link_descript: '最全跨境电商每日资讯', link_category: 'resourcesBuy', link_category_name: '资源购买' },
          { img_name: 'icon3.png', link_url: 'http://www.baidu.com', link_name: '跨境头条', link_descript: '最全跨境电商每日资讯', link_category: 'resourcesBuy', link_category_name: '资源购买' },
          { img_name: 'icon4.png', link_url: 'http://www.baidu.com', link_name: '跨境头条', link_descript: '最全跨境电商每日资讯', link_category: 'resourcesBuy', link_category_name: '资源购买' },
          { img_name: 'icon1.png', link_url: 'http://www.baidu.com', link_name: '跨境头条', link_descript: '最全跨境电商每日资讯', link_category: 'resourcesBuy', link_category_name: '资源购买' },
          { img_name: 'icon3.png', link_url: 'http://www.baidu.com', link_name: '跨境头条', link_descript: '最全跨境电商每日资讯', link_category: 'resourcesBuy', link_category_name: '资源购买' },
          { img_name: 'icon2.png', link_url: 'http://www.baidu.com', link_name: '跨境头条', link_descript: '最全跨境电商每日资讯', link_category: 'resourcesBuy', link_category_name: '资源购买' },
          { img_name: 'icon2.png', link_url: 'http://www.baidu.com', link_name: '跨境头条', link_descript: '最全跨境电商每日资讯', link_category: 'resourcesBuy', link_category_name: '资源购买' }
